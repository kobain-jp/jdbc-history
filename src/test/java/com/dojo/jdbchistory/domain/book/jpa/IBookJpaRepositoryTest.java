...
import com.dojo.jdbchistory.domain.book.jpa.IBookJpaRepository;
...
class IBookJpaRepositoryTest {
	...
	public void testCreate() {
		...
		assertThat(it.findById(4L).orElse(null), is(samePropertyValuesAs(book)));
